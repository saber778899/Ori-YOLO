...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--img-path', default='/home/liuhaoan/BPJDet_0102/BPJDet-BPJDetPlus/test_imgs/0217.jpg', help='path to image or dir')
    parser.add_argument('--data', type=str, default='/home/liuhaoan/BPJDet_0102/BPJDet-BPJDetPlus/data/JointBP_HumanParts.yaml')
    parser.add_argument('--imgsz', type=int, default=1024)  # 128*8
    parser.add_argument('--weights', default='/home/liuhaoan/BPJDet_0102/BPJDet-BPJDetPlus/runs/train/exp2/weights/best_mMR.pt')
