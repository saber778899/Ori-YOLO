...
if __name__ == '__main__':
    ...
    # video options
    parser.add_argument('-p', '--video-path', default='/home/liuhaoan/BPJDet_1120/BPJDet-BPJDetPlus/test_imgs/test_video_2.mp4', help='path to video file')

    parser.add_argument('--data', type=str, default='/home/liuhaoan/BPJDet_1120/BPJDet-BPJDetPlus/data/JointBP_HumanParts.yaml')
    parser.add_argument('--imgsz', type=int, default=1024)  # 128*8
    parser.add_argument('--save-size', type=int, default=960)
    parser.add_argument('--weights', default='/home/liuhaoan/BPJDet_1120/BPJDet-BPJDetPlus/runs/train/exp43_1208/weights/best_mMR.pt')
