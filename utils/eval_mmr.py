...
class COCOMReval:
    ...
    def __init__(self, cocoGt=None, cocoDt=None, iouType='segm', body_part='face'):
        ...
        if not cocoGt is None:
            ...
            # ids = []
            # imgpath = '/Users/wanjunfeng/Desktop/workspace/CrowdHuman_full_cocostyle/Images'
            # for img in os.listdir(imgpath):
            #     for key, value in cocoGt.imgs.items():
            #         if value['file_name'] == img:
            #             ids.append(key)
            # idall = cocoGt.getImgIds()
            # iduse = list(set(ids).intersection(set(idall)))
            # self.params.imgIds = sorted(iduse)
    ...
    def summarize(self,id_setup):
        ...
        def _summarize(iouThr=None, maxDets=100 ):
            ...
            titleStr = 'Average Miss Matching Rate'
            typeStr = '(mMR)'
...
class Params:
    ...
    def setDetParams(self):
        ...
        # thresholds of body iou / face iou
...
def eval_mmr(anno_file, json_result_file, match_part='face'):
    mr_res_dict = OrderedDict()
    iou_type="bbox"
    body_part=match_part
    id_c = 0
    mean_s_list = []
